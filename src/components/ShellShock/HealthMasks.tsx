...
export const HealthMasks = ({ health, isPlayer }: HealthMasksProps) => {
  const maxHealth = 3;
  const heartImage = '/src/assets/heart.png'; // or you can import it: import heartImage from '../assets/heart.png'
  const activeBorderColor = isPlayer ? '#9ca3af' : '#d6c28a';
  const inactiveBorderColor = isPlayer ? '#374151' : '#5b4630';
      ...
      {Array.from({ length: maxHealth }).map((_, i) => (
        <motion.div
          ...
          style={{ 
            ...
            borderColor: i < health ? activeBorderColor : inactiveBorderColor
          }}
        >
          <img 
            src={heartImage} 
