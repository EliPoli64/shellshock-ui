...
const SOUNDS = {
  ...
  itemUse: 'https://assets.mixkit.co/active_storage/sfx/2577/2577-preview.mp3', // Generic click/shuffle DONE
  ...
  win: 'https://assets.mixkit.co/active_storage/sfx/767/767-preview.mp3', // Victory chime DONE
  loss: 'https://assets.mixkit.co/active_storage/sfx/470/470-preview.mp3', // Low hit/fail DONE
  uiClick: 'https://assets.mixkit.co/active_storage/sfx/2568/2568-preview.mp3', // Soft UI click DONE
  keyPress: 'https://assets.mixkit.co/active_storage/sfx/2568/2568-preview.mp3', // Keyboard typing sound (reusing soft click for now) DONE
};
